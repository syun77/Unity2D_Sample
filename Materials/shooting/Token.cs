...
public class Token : MonoBehaviour {
	...
	public float Scale
	{
		...
		set { Vector3 scale = transform.localScale; scale.x = value; scale.y = value; }
	}
	/// スケール値を足し込む
	...
	{
		get { Vector2 v = rigidbody2D.velocity; return Mathf.Atan2(v.y, v.x) * Mathf.Rad2Deg; }
	}
	/// 速度
	public float Speed
	{
		get { Vector2 v = rigidbody2D.velocity; return Mathf.Sqrt(v.x*v.x + v.y*v.y); }
	}
	/// 回転角度
	public float Angle
	{
